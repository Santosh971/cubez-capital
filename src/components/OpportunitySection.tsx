...
const OpportunitySection = () => {
  ...
  return (
    <section id="opportunity" className="section-padding bg-background">
      <div className="section-container">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-gold font-medium text-sm tracking-widest uppercase">Current Opportunity</span>
            <h2 className="text-3xl md:text-4xl font-bold mt-3 mb-4">
              Class B Preferred Shares — <span className="text-gold">Now Open</span>
            </h2>
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg bg-gold/5 border border-gold/20 mb-6">
          ...
          >
            {[
              ...
              <div key={i} className="flex justify-between items-center p-4 rounded-lg bg-secondary border border-border">
                <span className="text-muted-foreground font-medium text-sm">{item.label}</span>
                <span className={`font-semibold text-sm ${item.highlight ? "text-gold" : "text-foreground"}`}>
                  {item.value}
                </span>
              </div>
            ))}
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              <span className="text-sm text-muted-foreground">Offering closes when fully subscribed</span>
            </div>
          </motion.div>
        </div>
      </div>
