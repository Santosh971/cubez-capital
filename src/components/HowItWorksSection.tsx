...
// import { UserPlus, FileText, Wallet, TrendingUp } from "lucide-react";
...
//       >
//         <span className="text-gold font-medium text-sm tracking-widest uppercase">How It Works</span>
//         <h2 className="text-3xl md:text-4xl font-bold mt-3 mb-4">
//           Start Investing in <span className="text-gold">Four Simple Steps</span>
//         </h2>
//       </motion.div>
...
//             >
//               <div className="w-24 h-24 rounded-full bg-background border-2 border-gold flex items-center justify-center mx-auto mb-6 relative z-10">
